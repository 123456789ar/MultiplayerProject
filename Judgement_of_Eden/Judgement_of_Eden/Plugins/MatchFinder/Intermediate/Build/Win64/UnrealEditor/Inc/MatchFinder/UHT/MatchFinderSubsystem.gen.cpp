...
void FOnMatchFindingFailed_DelegateWrapper(const FMulticastScriptDelegate& OnMatchFindingFailed, const FString& Reason)
{
	...
	UMatchFinderSubsystem::~UMatchFinderSubsystem() {}
	struct Z_CompiledInDeferFile_FID_Judgement_of_Eden_Judgement_of_Eden_Plugins_MatchFinder_Source_MatchFinder_Public_MatchFinderSubsystem_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Judgement_of_Eden_Judgement_of_Eden_Plugins_MatchFinder_Source_MatchFinder_Public_MatchFinderSubsystem_h_Statics::EnumInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Judgement_of_Eden_Judgement_of_Eden_Plugins_MatchFinder_Source_MatchFinder_Public_MatchFinderSubsystem_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Judgement_of_Eden_Judgement_of_Eden_Plugins_MatchFinder_Source_MatchFinder_Public_MatchFinderSubsystem_h_1870170122(TEXT("/Script/MatchFinder"),
		Z_CompiledInDeferFile_FID_Judgement_of_Eden_Judgement_of_Eden_Plugins_MatchFinder_Source_MatchFinder_Public_MatchFinderSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Judgement_of_Eden_Judgement_of_Eden_Plugins_MatchFinder_Source_MatchFinder_Public_MatchFinderSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Judgement_of_Eden_Judgement_of_Eden_Plugins_MatchFinder_Source_MatchFinder_Public_MatchFinderSubsystem_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Judgement_of_Eden_Judgement_of_Eden_Plugins_MatchFinder_Source_MatchFinder_Public_MatchFinderSubsystem_h_Statics::EnumInfo));
